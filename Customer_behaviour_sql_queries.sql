...
where discount_applied = "yes" and purchase_amount >= (select avg(purchase_amount) from customer);
 ...
 -- which are the top five product with the highest average review rating
 select item_purchased , round(avg(review_rating ),2) as average from customer
 group by item_purchased order by average desc limit 5;
